        ...
        <Card title="MDT-команда" action={<Link href="/reports" className="text-xs text-accent hover:underline">Отчёты →</Link>}>
          <ul className="grid grid-cols-2 gap-2 text-sm">
            {[
              ...
              { name: "Онколог", role: "specialist" },
              { name: "Гастроэнтеролог", role: "specialist" },
              { name: "Гематолог", role: "specialist" },
              { name: "Нефролог", role: "specialist" },
              { name: "Пульмонолог", role: "specialist" },
